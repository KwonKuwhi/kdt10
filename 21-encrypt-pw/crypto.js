...
//  해시 함수의 한계: 레인보우 테이블
// => 암호화된 비밀번호를 빠르게 역추적해서 원본 비번을 찾아낼 수 있음
...
// 제공된 비번으랑 원래 비번이 같으면 두 해시 값도 일치
...
// 비밀번화 확인
const inputPW = '1234';
const isMatch = checkPW(inputPW, salt, hash); //true 또는 false
