...
//         }else{
//             reject(`현재 프로미스의 상태는 reject(거절), catch 메서드로 연결! flag: ${flag}`);
//             }
//         })
//     }
...
//     //-------------프로미스 예제
//     // index.js 에서 "콜백 함수"를 이용해서 동기처리한 코드를
//     // "promise"를 이용해 동기처리
...
//     }).catch(()=> console.log('돈이 부족하다,,'));
    ...
    //     setTimeout(function(){
    //         const result= n1 + n2;
    //         callback(result); // mul(result)
    //     }, 1000);
    // }
    // function mul(n, callback) {
    //     setTimeout(function(){
    //         const result = n * 2;
    //         callback(result); //sub(result)
    //     }, 700);
    // }
